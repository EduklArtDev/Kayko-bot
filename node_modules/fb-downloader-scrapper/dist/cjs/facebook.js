...
async function getFbVideoInfo(videoUrl, cookie, useragent) {
  return new Promise((resolve, reject) => {
    ...
    const parseString = /* @__PURE__ */ __name((string) => JSON.parse(`{"text": "${string}"}`).text, "parseString");
    ...
    import_axios.default.get(videoUrl, { headers }).then(({ data }) => {
      var _a, _b;
...
__name(getFbVideoInfo, "getFbVideoInfo");
