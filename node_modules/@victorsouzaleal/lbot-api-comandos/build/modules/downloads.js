        ...
        try {
            ...
            await axios.get(url).then(({ data }) => {
                ...
                data.media_extended.forEach((midia) => {
                    var _a, _b;
                    if (midia.type == 'video') {
                        (_a = resposta.resultado) === null || _a === void 0 ? void 0 : _a.midias.push({
                            tipo: 'video',
                            url: midia.url
                        });
                    }
                    else if (midia.type == 'image') {
                        (_b = resposta.resultado) === null || _b === void 0 ? void 0 : _b.midias.push({
                            tipo: 'imagem',
                            url: midia.url
                        });
                    }
        ...
        try {
            ...
            await Tiktok.Downloader(url, { version: "v1" }).then((resultado) => {
                ...
                if (resultado.status == "success") {
                    resposta.resultado = {
                        autor_perfil: (_a = resultado.result) === null || _a === void 0 ? void 0 : _a.author.nickname,
                        descricao: (_b = resultado.result) === null || _b === void 0 ? void 0 : _b.description,
                        tipo: ((_c = resultado.result) === null || _c === void 0 ? void 0 : _c.type) == "video" ? "video" : "imagem",
                        duracao: ((_d = resultado.result) === null || _d === void 0 ? void 0 : _d.type) == "video" ? parseInt((((_f = (_e = resultado.result) === null || _e === void 0 ? void 0 : _e.video) === null || _f === void 0 ? void 0 : _f.duration) / 1000).toFixed(0)) : null,
                        url: ((_g = resultado.result) === null || _g === void 0 ? void 0 : _g.type) == "video" ? (_j = (_h = resultado.result) === null || _h === void 0 ? void 0 : _h.video) === null || _j === void 0 ? void 0 : _j.playAddr[0] : (_k = resultado.result) === null || _k === void 0 ? void 0 : _k.images
                    };
                    resolve(resposta);
                }
                else {
        ...
        try {
            ...
            ytdl.getInfo(id_video, {
                ...
                if (err.message == "Status code: 410")
                    resposta.erro = 'O video parece ter restrição de idade ou precisa de ter login para assistir.';
                else
                    resposta.erro = 'Houve um erro ao obter as informações do video.';
                reject(resposta);
            });
...
export const obterYTMP4 = async (texto) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            let videoStream = ytdl(infoVideo === null || infoVideo === void 0 ? void 0 : infoVideo.videoId, { format: infoVideo === null || infoVideo === void 0 ? void 0 : infoVideo.format, agent: yt_agent });
