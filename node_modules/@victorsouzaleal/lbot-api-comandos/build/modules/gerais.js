    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            $animes.forEach($anime => {
                var _a, _b, _c;
                animes.push({
                    nome: (_a = $anime.querySelector('h3')) === null || _a === void 0 ? void 0 : _a.innerHTML,
                    episodio: (_b = $anime.querySelector('span.numEp')) === null || _b === void 0 ? void 0 : _b.innerHTML,
                    link: (_c = $anime.querySelector('a')) === null || _c === void 0 ? void 0 : _c.href
                });
            });
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            $mangas.forEach($manga => {
                var _a, _b, _c;
                mangas.push({
                    nome: (_a = $manga.querySelector('h3.chapter-title > span.series-name')) === null || _a === void 0 ? void 0 : _a.innerHTML.trim(),
                    capitulo: (_b = $manga.querySelector('h3.chapter-title > span.chapter-name')) === null || _b === void 0 ? void 0 : _b.innerHTML.trim(),
                    link: `https://mangabr.net${(_c = $manga.querySelector('a.link-chapter')) === null || _c === void 0 ? void 0 : _c.getAttribute('href')}`
                });
            });
...
export const obterDadosBrasileirao = async (serie = "A") => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (serie === 'A')
                dadosBrasileirao = await obterDadosBrasileiraoA();
            else if (serie === 'B')
                dadosBrasileirao = await obterDadosBrasileiraoB();
            else {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            await axios.get(climaAPIURL).then(async (res) => {
                let dadosClima = res.data;
                const { data: condicoesClima } = await axios.get("https://www.weatherapi.com/docs/conditions.json", { responseType: 'json' });
                const condicaoAtual = (condicoesClima.find((condicao) => condicao.code == dadosClima.current.condition.code)).languages.find((idioma) => idioma.lang_iso == 'pt');
                resposta.resultado = {
                    local: {
                ...
                dadosClima.forecast.forecastday.forEach((previsao) => {
                    ...
                    (_a = resposta.resultado) === null || _a === void 0 ? void 0 : _a.previsao.push(dadosPrevisao);
                });
                resolve(resposta);
            }).catch(() => {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            await axios.get("https://gist.githubusercontent.com/victorsouzaleal/bfbafb665a35436acc2310d51d754abb/raw/df5eee4e8abedbf1a18f031873d33f1e34ac338a/cartas.json").then(async (github_gist_cartas) => {
                ...
                if (cartaPretaEscolhida.indexOf("{p3}") != -1)
                    cont_params = 3;
                else if (cartaPretaEscolhida.indexOf("{p2}") != -1)
                    cont_params = 2;
                else
                    cont_params = 1;
